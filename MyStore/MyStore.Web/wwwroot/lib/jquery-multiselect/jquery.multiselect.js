    ...
    MultiSelect.prototype = {
        ...
        load: function() {
            ...
            optionsWrap.on('click', 'input[type="checkbox"]', function () {
                ...
                if (pagename === "addZone" || pagename === "editZone") {
                    if ($(this).is(':checked')) {
        ...
        _updatePlaceholderText: function(){
            ...
            else if (pagename === "addZone" || pagename === "editZone") {
                var selectedOptionsTitle = [];
                var selectedOptions = $(instance.element).find('option:selected');
                Array.prototype.forEach.call(selectedOptions, option => {
                    selectedOptionsTitle.push(option.text);
                });
                placeholderTxt.text(selectedOptionsTitle.join(', '));
